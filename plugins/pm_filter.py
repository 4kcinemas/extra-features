...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons= [[
            InlineKeyboardButton('𝖲𝗈𝗎𝗋𝖼𝖾', url='https://github.com/4kcinemas'),
            InlineKeyboardButton('𝖬𝗈𝗏𝗂𝖾𝗌', url='https://t.me/+72jLj5JaYgc1MjU1'),
...
async def advantage_spell_chok(msg):
    ...
    if not movielist:
        k = await msg.reply_str("CAACAgUAAxkBAAEN125iJLH_huw6lTleKqOxmqwCxLGpiAACugIAAkGL-VTQ6rE0nuUb2B4E")
        await asyncio.sleep(8)
        await k.delete()
        return
