...
async def next_page(bot, query):
    ...
    if int(req) not in [query.from_user.id, 0]:
        return await query.answer("⚠️ 𝗛𝗲𝘆, {user.mention} ! 𝗧𝗵𝗶𝘀 𝗶𝘀 𝗡𝗼𝘁 𝗙𝗼𝗿 𝗬𝗼𝘂 𝗣𝗹𝗲𝗮𝘀𝗲 𝗦𝗲𝗮𝗿𝗰𝗵 𝗬𝗼𝘂𝗿 𝗢𝘄𝗻.", show_alert=True)
    try:
        offset = int(offset)
    except:
        offset = 0
    ...
    if not search:
        await query.answer("𝗟𝗶𝗻𝗸 𝗘𝘅𝗽𝗶𝗿𝗲𝗱 𝗞𝗶𝗻𝗱𝗹𝘆 𝗣𝗹𝗲𝗮𝘀𝗲 𝗦𝗲𝗮𝗿𝗰𝗵 𝗔𝗴𝗮𝗶𝗻 🙂.", show_alert=True)
        return
...
async def advantage_spoll_choker(bot, query):
    ...
    if not movies:
        return await query.answer("𝗟𝗶𝗻𝗸 𝗘𝘅𝗽𝗶𝗿𝗲𝗱 𝗞𝗶𝗻𝗱𝗹𝘆 𝗣𝗹𝗲𝗮𝘀𝗲 𝗦𝗲𝗮𝗿𝗰𝗵 𝗔𝗴𝗮𝗶𝗻 🙂.", show_alert=True)
    ...
    if k == False:
        ...
        if files:
            ...
            k = await query.message.edit('𝗦𝗼𝗿𝗿𝘆 𝗧𝗵𝗶𝘀 𝗠𝗼𝘃𝗶𝗲 𝗡𝗼𝘁 𝗔𝘃𝗮𝗶𝗯𝗹𝗲, 𝗢𝘂𝗿 𝗔𝗱𝗺𝗶𝗻𝘀 𝗪𝗶𝗹𝗹 𝗔𝗱𝗱 𝗦𝗼𝗼𝗻 😌')
